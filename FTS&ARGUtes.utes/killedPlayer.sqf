	...
	switch (true) do
		{
			...
			case ((_killedDistance >= 100) && (_killedDistance < 500)): {systemChat format ["SYSTEM: %1 was murdered by %2 from %3 meters away",_realNameVictim,_realNameKiller,_killedDistance];};
...
switch (true) do
{
	...
	case (dez_killStreak = 10): {["10",dez_killStreak] execVM "killStreaks.sqf";};
