...
Private ["_ammoBox","_randWeapons","_randItems"];
	...
	switch (_randItems) do
	{
		...
		case 2: {
					_box addItemCargoGlobal["optic_MRCO",1];
					_box addItemCargoGlobal["muzzle_snds_H",1];
					_box addItemCargoGlobal["muzzle_snds_L",1];
					_box addItemCargoGlobal["muzzle_snds_H_MG",1];
		...
		case 3: {
					...
					_box addItemCargoGlobal["optic_Arco",1];
					_box addItemCargoGlobal["muzzle_snds_B",1];
					_box addItemCargoGlobal["muzzle_snds_H_MG",1];
					_box addItemCargoGlobal["FirstAidKit",5];
					_box addItemCargoGlobal["optic_tws",1];
				};
		case 4: {
					_box addItemCargoGlobal["optic_Holosight",1];
					_box addItemCargoGlobal["optic_Hamr",1];
		...
		case 6: {
					...
					_box addItemCargoGlobal["muzzle_snds_H",1];
					_box addItemCargoGlobal["muzzle_snds_L",1];
					_box addItemCargoGlobal["muzzle_snds_M",1];
					_box addItemCargoGlobal["muzzle_snds_B",1];
					_box addItemCargoGlobal["muzzle_snds_H_MG",1];
					_box addItemCargoGlobal["FirstAidKit",5];
					_box addItemCargoGlobal["ToolKit",1];
